...
public class TitleBitmapButton extends AppCompatButton {
	...
	int backgroundBitmapNormal = R.drawable.normal_btn_normal;
	int backgroundBitmapClicked = R.drawable.normal_btn_clicked;
	...
	public void onDraw(Canvas canvas) {
		...
		if (iconBitmap != null) {
			...
			canvas.drawBitmap(iconBitmap, bitmapX-110, (curHeight-iconHeight)/2, paint);
		}
